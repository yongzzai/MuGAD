...
def get_model_args(args):
    return {'hidden_dim': args.hidden_dim, 'emb_dim': args.emb_dim, 'num_conv_layer': args.num_conv_layer,
            'pretrain_epoch': args.pretrain_epoch, 'adapt_epoch': args.adapt_epoch,
            'learning_rate': args.learning_rate, 'batch_size': args.batch_size,
            'thres': args.thres, 'beta': args.beta, 'k': args.k, 'emb_dim': args.emb_dim}